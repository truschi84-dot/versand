...
|--------|------------------------------|-----------------|
| Datei | `index.html`, `js/`, … | `kaninchen/` (eigener Ordner, getrennte PWA) |
...
powershell -File projekt\scripts\publish-kaninchen.ps1 -PushToGitHub -Message "Kaninchen-Futterplan online"
```
